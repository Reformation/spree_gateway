...
describe "Stripe checkout" do
  ...
  it "shows an error with an invalid credit card number", :js => true do
    click_button "Save and Continue"
    page.should have_content("Payments credit card Number can't be blank")
  end
  ...
  it "shows an error with invalid security fields", :js => true do
    ...
    fill_in "Expiration", :with => "01 / #{Time.now.year + 1}"
    click_button "Save and Continue"
    page.should have_content("Payments credit card Verification Value can't be blank")
  end
  ...
  it "shows an error with invalid expiry fields", :js => true do
    ...
    fill_in "Card Code", :with => "123"
    click_button "Save and Continue"
    page.should have_content("Payments credit card Card expiration is invalid")
  end
end